...
$ai = new AiService(
    ...
    [
        ...
        'groq_model'        => env_value('GROQ_MODEL', 'llama-3.3-70b-versatile'),
        'mistral_api_key'   => env_value('MISTRAL_API_KEY'),
        'mistral_model'     => env_value('MISTRAL_MODEL', 'mistral-large-latest'),
        'openrouter_api_key' => env_value('OPENROUTER_API_KEY'),
        'openrouter_model'  => env_value('OPENROUTER_MODEL', 'anthropic/claude-sonnet-4'),
        'xai_api_key'       => env_value('XAI_API_KEY'),
        'xai_model'         => env_value('XAI_MODEL', 'grok-3-fast'),
        'together_api_key'  => env_value('TOGETHER_API_KEY'),
        'together_model'    => env_value('TOGETHER_MODEL', 'meta-llama/Llama-3.3-70B-Instruct-Turbo'),
