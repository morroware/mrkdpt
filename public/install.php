  ...
  <form method="post">
    ...
    <div class="grid">
      ...
      <div>
        ...
        <input id="admin_password" name="admin_password" type="password" <?= $hasUsers ? '' : 'required' ?> />
      </div>
    </div>
    <?php if ($hasUsers): ?>
    ...
    <div class="grid">
      ...
      <div class="full">
        ...
        <input id="OPENAI_API_KEY" name="OPENAI_API_KEY" value="<?= esc($values['OPENAI_API_KEY']) ?>" placeholder="sk-..." />
      </div>
      <div>
      ...
      <div class="full">
        ...
        <input id="ANTHROPIC_API_KEY" name="ANTHROPIC_API_KEY" value="<?= esc($values['ANTHROPIC_API_KEY']) ?>" placeholder="sk-ant-..." />
      </div>
      <div>
